                            ...
                            <div class="grid col-span-3">
                                ...
                                <div
                                    ...
                                    <div class="mt-4 lg:row-span-3 lg:mt-0">
                                        ...
                                        <p>
                                            @if ($cantTalles > 0)
                                                <span>Tiene {{ $cantTalles }} talles</span>
                                            @endif
                                        </p>
                                        <p>
                                            Tiene {{ $cantTalles }} talles 2 <br>
                                            Tiene {{ $cantColores }} colores 2
                                        </p>
                                        <div>

                                        </div>
                                        {{-- <p>Colores: {{ $colores->count() }}</p>
                                        <p>Talles: {{ $talles->count() }}</p> --}}

                                        {{-- <p>Colores: {{ count($colores) }}</p>
                                        <p>Talles: {{ count($talles) }}</p> --}}
