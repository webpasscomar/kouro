<x-slot name="header">
	<h1 class="text-gray-900">Gestión de Parámetros</h1>
</x-slot>
				...
				<tbody>
					...
					<tr>
						...
						<td class="border px-4 py-2 text-center">
							<button wire:click="editar({{$p->id}})" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4">Editar</button>
							<button wire:click="borrar({{$p->id}})" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4">Borrar</button>
						</td>
					</tr>
					@endforeach
				</tbody>
