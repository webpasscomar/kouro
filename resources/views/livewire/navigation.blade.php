<div>
  ...
  ============================================= -->
    <div id="top-bar">
      ...
      ============================================= -->
                    <ul id="top-social">
                        <li><a href="https://es-es.facebook.com/lineafinacueros/" class="h-bg-facebook"
                                target="_blank"><span class="ts-icon"><i class="fa-brands fa-facebook-f"></i></span><span
                                    class="ts-text">Facebook</span></a>
                        </li>
                        <li><a href="https://www.instagram.com/kouro_leather" class="h-bg-instagram"><span
                                    class="ts-icon"><i class="fa-brands fa-instagram" target="_blank"></i></span><span
                ...
                <div id="logo" class="ms-auto ms-lg-0 me-lg-auto">
                    <a href="{{ route('home') }}">
                        <img class="logo-default"
                            srcset="{{ asset('img/logo.png') }}, demos/construction/images/logo@2x.png 2x"
                        ...
                        <div id="top-search" class="header-misc-icon position-relative">
                            <a href="{{ route('carrito') }}" class="relative" role="button">
                                ...
                                @if ($carrito > 0)
                                    {{--                  <span class=""> --}}
                                    <span
                                        class="badge bg-danger rounded-pill position-absolute top-0 start-100 translate-middle badge_cart">
                                        {{ $carrito }}
                                        {{--                    </span> --}}
                                    </span>
                                @endif
