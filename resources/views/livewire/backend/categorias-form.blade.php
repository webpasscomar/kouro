      ...
      <form>
        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 grid grid-cols-1 sm:grid-cols-2 gap-2">
          ...
          <div class="mb-3 col-span-2">
            ...
            <select
              ...
              @foreach ($categoriasAnt as $item)
                <option {{ old($item->categoriaPadre_id) == $item->id ? 'selected' : '' }} value="{{ $item->id }}">
                  {{ $item->categoria }}
                </option>
              @endforeach
            </select>
          ...
          <div class="mb-3 col-span-2">
            ...
            <p class="text-sm text-gray-500">La imagen debe ser .jpg de 600x400 px con un peso máximo de 150 kb.</p>
