        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 mb-2">
            ...
            <div class="py-3 my-2">
                ...
                <h4 class="text-xl text-gray-900 font-bold"><a href="{{ route('dashboard') }}"><i
                            class="fas fa-home"></i></a> - Productos
                </h4>
            </div>
                        ...
                        <td class="border px-4 py-2">
                            <div class="flex justify-center items-center gap-x-3">
                                ...
                                <button wire:click="imagenes({{ $item->id }})" class="w-5 hover:scale-125"
                                    title="Imágenes"><img src="{{ asset('./img/photo.svg') }}" alt="imagenes"></button>
                                <button wire:click="categorias({{ $item->id }})" class="w-5 hover:scale-125"><img
                                        src="{{ asset('./img/category.svg') }}" alt="categorias"
                                        title="categorias"></button>
