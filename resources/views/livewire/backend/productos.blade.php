          ...
          <tr>
            ...
            <td class="border px-4 py-2">
              <div class="flex justify-center items-center gap-x-3">
                <button wire:click="editar({{ $item->id }})" class="w-5 hover:scale-125" title="Editar"><img
                    src="{{ asset('./img/edit.svg') }}" alt="editar"></button>
                <button wire:click="imagenes({{ $item->id }})" class="w-5 hover:scale-125" title="Imágenes"><img
                    src="{{ asset('./img/photo.svg') }}" alt="imagenes"></button>
                {{-- <button wire:click="categorias({{ $item->id }})" class="w-5 hover:scale-125"><img
                src="{{ asset('./img/category.svg') }}" alt="categorias" title="categorias"></button> --}}
