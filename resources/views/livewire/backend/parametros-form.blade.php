      ...
      <form>
        ...
        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 grid grid-cols-1 sm:grid-cols-3 gap-2">
          ...
          <div class="mb-4 col-span-3">
            <label for="descripcion" class="block text-gray-700 text-sm font-bold mb-2">Parametro:</label>
          ...
          <div class="mb-4">
            <label for="default" class="block text-gray-700 text-sm font-bold mb-2">Valor por default:</label>
            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="default" wire:model="default">
          </div>

          <div class="mb-4">
            <label for="valor" class="block text-gray-700 text-sm font-bold mb-2">Valor actual:</label>
          ...
          <div class="mb-4">
            <label for="relacionados" class="block text-gray-700 text-sm font-bold mb-2">Relacionado con:</label>
            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="relacionados" wire:model="relacionados">
          </div>
