            ...
            <form>
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 grid grid-cols-1 sm:grid-cols-3 gap-2">
                    ...
                    <div class="mb-4 col-span-3">
                        ...
                        <textarea name="pregunta" id="pregunta" cols="50" rows="5" wire:model="pregunta"
                                  class="block text-gray-700 text-sm font-bold mb-2"></textarea>
                    ...
                    <div class="mb-4 col-span-3">
                        ...
                        <textarea name="respuesta" id="respuesta" cols="50" rows="5" wire:model="respuesta"
                                  class="block text-gray-700 text-sm font-bold mb-2"></textarea>
