        ...
        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 grid grid-cols-1 sm:grid-cols-2 gap-2">
          ...
          <div class="mb-3 col-span-2">
            ...
            <button type="button" onclick="document.getElementById('imagen').click()"
              class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 my-3">Seleccionar imagen
            </button>
            <!-- Leyenda de las restricciones para la imagen -->
            <p class="text-sm text-gray-500">La imagen debe ser .jpg de 2000x400 px con un peso máximo de 2 MB.</p>
          ...
          <div class="mb-3">
            ...
            @else
              @if ($accion === 'editar')
                <img class="h-20 w-20" src="{{ asset('storage/galeria/' . $imagen) }}" alt="">
              @endif
            @endif
          </div>
