    ...
    <div class="modal-content">
      <form>
        <div class="modal-header">
          <h5 class="modal-title" id="modal-headline">Formulario de Galería</h5>
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-md-8 form-group">
              ...
              <button type="button" class="btn btn-primary mt-2" onclick="document.getElementById('imagen').click()">
                Seleccionar imagen
              </button>
              <p class="form-text">La imagen debe ser .jpg de 2000x400 px con un peso máximo de 2 MB.</p>
              ...
              @if ($cambioImg)
                @if (gettype($imagen) === 'object')
                  @if (in_array($imagen->extension(), ['png', 'jpg', 'jpeg']))
                    <img src="{{ $imagen->temporaryUrl() }}" class="img-thumbnail" style="width: 80px; height: 80px;">
                  @endif
                @endif
