        ...
        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 grid grid-cols-1 sm:grid-cols-6 gap-2">
          ...
          <div class="mb-2  col-span-2">
            ...
            <select
              ...
              <option class="text-gray-400" value="0">Elija una categoría</option>
          ...
          <div class="mb-2">
            <label for="presentacion_id" class="block text-gray-700 text-sm font-bold mb-2">Presentacion:</label>
            <select
              class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
          ...
          <div class="mb-2">
            <label for="unidadVenta" class="block text-gray-700 text-sm font-bold mb-2">Unidad de venta:</label>
            <input type="text"
              class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
              id="unidadVenta" wire:model="unidadVenta" value="1"> <!-- Valor por defecto -->
