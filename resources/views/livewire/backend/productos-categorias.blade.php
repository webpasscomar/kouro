<div class="fixed z-50 inset-0 overflow-y-auto ease-out duration-400">
    <div class="flex justify-center pt-4 px-4 pb-4 text-center w-full">
        ...
        <div
            class="inline-block self-center h-96 bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all lg:max-w-4xl md:max-w-2xl sm:w-full"
