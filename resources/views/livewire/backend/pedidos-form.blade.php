<div class="fixed z-50 inset-0 overflow-y-auto ease-out duration-400">
    <div class="flex justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div
            class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-7xl p-5"
            ...
            <form>
                ...
                @else
                    ...
                    <div class="grid grid-cols-4 gap-3">
                        ...
                        <div>
                            <label for="entrega_id" class="block text-gray-700 text-sm font-bold mb-2">Forma de
                                entrega</label>
                            <select
                        ...
                        <div>
                            <label for="transac_mp" class="block text-gray-700 text-sm font-bold mb-2">Transaccion
                                Mercado Pago</label>
                            <input type="text"
                                   class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    ...
                    <div class="my-5">
                        ...
                        {{-- class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 my-3">+ Nuevo Item--}}
                        {{--                        </button>--}}
                        <button wire:click.prevent="nuevo()"
