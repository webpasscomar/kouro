            ...
            <div class="flex flex-wrap">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <a href="{{ route('producto', $producto->id) }}">
                            <div class="bg-white rounded-lg overflow-hidden shadow-md">
                                <img class="w-full h-56 object-cover object-center" src="{{ asset('storage/productos/' . $producto->id . '.jpg') }}" alt="{{ $producto->titulo }}">
                                <div class="p-4">
                ...
                <div class="w-1/4 p-4">
                    ...
                    <ul class="text-gray-700 text-base">
                        ...
                        <li class="mb-2">
                            <a href="#" wire:click.prevent="setCategoria('{{ $categoria->slug }}')">{{ $categoria->categoria }}</a>
                        </li>
                        @endforeach
                    </ul>
                </div>
