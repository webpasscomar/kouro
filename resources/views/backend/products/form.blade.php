      ...
      <form action="{{ isset($product) ? route('products.update', $product->id) : route('products.store') }}"
        ...
        <div class="row">
          ...
          <div class="col">
            <div class="form-group">
              ...
              <select name="presentacion_id" class="form-select @error('presentacion_id') is-invalid @enderror">
          ...
          <div class="col">
            <div class="form-group">
              ...
              <input type="text" name="precioLista" class="form-control @error('precioLista') is-invalid @enderror"
          ...
          <div class="col">
            <div class="form-group">
              ...
              <input type="text" name="precioOferta" class="form-control @error('precioOferta') is-invalid @enderror"
          ...
          <div class="col">
            <div class="form-group">
              ...
              <input type="date" name="ofertaDesde" class="form-control @error('ofertaDesde') is-invalid @enderror"
          ...
          <div class="col">
            <div class="form-group">
              ...
              <input type="date" name="ofertaHasta" class="form-control @error('ofertaHasta') is-invalid @enderror"
        ...
        <div class="row">
          ...
          <div class="col">
            <div class="form-group">
              ...
              <input type="text" name="tamano" class="form-control @error('tamano') is-invalid @enderror"
          ...
          <div class="col">
            <div class="form-group">
              ...
              <input type="text" name="unidadVenta" class="form-control @error('unidadVenta') is-invalid @enderror"
          ...
          <div class="col">
            <div class="form-group">
              ...
              <select name="destacar" class="form-select @error('destacar') is-invalid @enderror">
                <option value="0" {{ isset($product) && $product->destacar == 0 ? 'selected' : '' }}>No</option>
                <option value="1" {{ isset($product) && $product->destacar == 1 ? 'selected' : '' }}>Sí</option>
              </select>
              @error('destacar')
                <span class="text-danger ml-1">{{ $message }}</span>
              @enderror
        ...
        <div class="form-group">
          ...
          <select name="estado" class="form-select @error('estado') is-invalid @enderror">
            <option value="1" {{ isset($product) && $product->estado == 1 ? 'selected' : '' }}>Activo</option>
            <option value="0" {{ isset($product) && $product->estado == 0 ? 'selected' : '' }}>Inactivo</option>
          </select>
          @error('estado')
            <span class="text-danger ml-1">{{ $message }}</span>
          @enderror
