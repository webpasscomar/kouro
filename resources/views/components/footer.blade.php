<div role="contentinfo" class="relative flex w-full flex-col h-28 text-gray-800 bg-slate-400 mt-20 justify-center p-10">

    <div class="flex mt-1 w-auto items-center justify-around">
        ...
        <div class="flex gap-x-5">
            ...
            <a href="mailto:kouroarg@gmail.com" class="flex items-center">
                ...
                <span class="ml-2" title="email">
                    <strong class="text-base font-semibold">kouroarg@gmail.com</strong>
                </span>
            </a>
            {{-- Whatsapp --}}
    ...
    <div class="flex mt-5 justify-center">
        ...
        <button
            class="absolute right-10 bottom-7 bg-slate-500 text-white p-3 rounded-full w-12 h-12 shadow shadow-slate-500 hover:bg-slate-600"
